...
const Product = () => {
    ...
    const [description, setDescription] = useState("")
    const [stock, setStock] = useState("")
    const [imageFiles, setImageFiles] = useState([])       // <-- store actual files here
    const [imagePreview, setImagePreview] = useState([])   // <-- store base64 previews here
    const [category, setCategory] = useState("")
    ...
    const handleCreateProduct = (e) => {
        ...
        // Append actual File objects here, NOT base64 strings
    ...
    const createImageProduct = (e) => {
        ...
        setImageFiles(files);  // Save the files for uploading
        ...
        files.forEach((file) => {
            ...
            reader.onload = () => {
                if (reader.readyState === 2) {
                    setImagePreview((old) => [...old, reader.result]);  // Save base64 preview
                }
            };
